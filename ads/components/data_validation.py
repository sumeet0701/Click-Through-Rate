...
from ads.entity import config_entity, artifact_entity
from ads import utils
from ads.config import TARGET_COLUMN
import pandas as pd
...
class DataValidation:
    ...
    def drop_missing_values_columns(self, df:pd.DataFrame, report_key_name:str)-> Optional[pd.DataFrame]:
        ...
        try:
            ...
            logging.info(f"Selecting column name which contain null values aboves to{threshold}")
            drop_column_name = null_report[null_report>threshold].index

            logging.info(f"Column to drop :{list(drop_column_name)}")
